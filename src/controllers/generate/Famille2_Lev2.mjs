            ...
            if (completed.renseignement == true && completed.description == true && completed.examen == true && completed.conclusion == true && completed.photo == true) {
                ...
                var doc = new Docxtemplater()
                    ...
                    .setData({
                        ...
                        modeLevage: description.modeLevage,
                        chargeMaximaleUtile: description.chargeMaximaleUtile,
                        hauteurDeLevage: description.hauteurDeLevage,
                        course: description.course,
                        hauteurLevage: description.hauteurLevage,
                        portee: description.portee,
                        porteFaux: description.porteFaux,
                        longueurCheminRoulement: description.longueurCheminRoulement,
                        suspentesLevage: String(description.suspentesLevage),
                        mouflage: description.mouflage,
                        diametre: description.diametre,
                        ...
                        complementSourceEnergie : description.complementSourceEnergie,

                        // detailsSourceEnergie : detailsSourceEnergie,
