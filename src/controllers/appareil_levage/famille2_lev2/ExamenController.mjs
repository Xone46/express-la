...
const create = async (request, response) => {
    ...
    try {
        ...
        if(exist) {
            ...
            await ExamenFamilleTowLevTow.updateOne({ observateurId : observateurId }, { $set : { a : a, b : b, c : c, d : d, e : e, f : f, g : g, h : h, i : i, j : j, k : k }})
            .then(() => {
            ...
            await ExamenFamilleTowLevTow({ a, b, c, d, e, f, g, h, i, j, k, observateurId })
            .save()
            .then(async () => {
