...
const create = async (request, response) => {
    ...
    try {
        ...
        if(exist) {
            ...
            await ExamenFamilleFourLevFour.updateOne({ observateurId : observateurId }, { $set : { a : a, b : b, c : c, d : d, e : e, f : f, g : g, h : h, i : i, j : j }})
            .then(() => {
            ...
            await ExamenFamilleFourLevFour({ a, b, c, d, e, f, g, h, i, j, observateurId })
            .save()
            .then(async () => {
