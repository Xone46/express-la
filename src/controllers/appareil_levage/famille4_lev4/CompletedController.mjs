...
const checkRenseignement = async (request, response) => {
    ...
    try {
        const completed = await CompletedFamilleFourLevFour.find({ observateurId: observateurId, renseignement: true });
...
const checkAll = async (request, response) => {
    ...
    try {
        ...
        const completed = await CompletedFamilleFourLevFour.find({ observateurId: observateurId, renseignement: true , description : true, examen : true, conclusion : true, photo: true });
